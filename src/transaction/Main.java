...
public class Main {
    public static void main(String[] args) {
        ...
        //밀라노에 거래자가 있는가?
        if(transactions.stream().anyMatch(trader->trader.getTrader().getCity().equals("Milan"))){
        ...
        Optional<Transaction> min3 = transactions.stream().min(comparing(Transaction::getValue));
